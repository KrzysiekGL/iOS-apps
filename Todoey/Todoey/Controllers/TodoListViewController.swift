...
//  Todoey
//
//  Created by Krzysztof Szczerbowski on 11/09/2018.
...
class TodoListViewController: UITableViewController {
    ...
    //MARK: - Tableview Datasource Methods (Robienie tabelek w TableView)
...
//        itemArray.remove(at: indexPath.row)
    ...
    //MARK: - UISearchBar Functionality For TodoListViewController
